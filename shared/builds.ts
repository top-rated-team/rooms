...
export const BUILDS: Build[] = [
  {
    ...
    "unverifiedClaims": [
      ...
      "That https://top-rated.team serves this application. It does not, on the repository's own evidence: private/apex-migration.md lists fourteen addresses on the apex that must answer before the DNS record is moved, two of which (/team and /roi-calculator) are still marked unsettled. The url field is the apex on the owner's instruction about the published address, not a description of what is behind it today.",
