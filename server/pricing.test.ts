...
const NOT_A_PRICE: Record<string, string> = {
  "$2M+":
    "the firm's record — client ad spend managed, not a charge. It is on the first screen and, as a credential, in every agent's prompt.",
...
describe("every currency figure an agent is given is a price this site publishes", () => {
   ...
   */
  const ALLOWED_CREDENTIAL = "$2M+ ad spend managed";
