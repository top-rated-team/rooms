 ...
 * would send the invoice. The rest is on the door's own page, one click away,
  ...
  return (
    ...
    >
      ...
      {/* The name is the row's way in, on every row, whatever its status: a
          ...
          company that would invoice. One link and no second button — a row with
      ...
      {/* Whoever is named here is who the room names, and it is the one fact on
          this row that costs money to get wrong. */}
